...
function watch() {
    ...
    gulp.watch('**/*.php', reload)
        .on('change', path => log('File ' + colors.bold(colors.magenta(path)) + ' changed.'))
        .on('unlink', path => log('File ' + colors.bold(colors.magenta(path)) + ' was removed.'));
    gulp.watch('twig-templates/**/*.twig', reload)
        .on('change', path => log('File ' + colors.bold(colors.magenta(path)) + ' changed.'))
        .on('unlink', path => log('File ' + colors.bold(colors.magenta(path)) + ' was removed.'));
...
gulp.task('sitemap', shell.task(['curl --silent --output sitemap.json http://fptemplate.local/\?show_sitemap']));
//gulp uncss based on sitemap generated with task above
...
// Package task
gulp.task('package',
    gulp.series('build', 'sitemap', 'uncss', archive));